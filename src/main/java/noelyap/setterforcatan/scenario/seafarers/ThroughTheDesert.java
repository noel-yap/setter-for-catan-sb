...
public class ThroughTheDesert {
  private static final Matcher<ConfigurationOuterClass.Configuration> CONFIGURATION_MATCHER =
      IsNot.not(AllOf.allOf(IsTileType.isTileType(GOLD_FIELD), HasHighOdds.hasHighOdds()));

  private static final Tuple2<Array<Tile>, Boolean> P3_INDIGENOUS_TILES =
      Tuple.of(
  ...
  private static final Array<Coordinate> P3_INDIGENOUS_COORDINATES =
      Array.of(
  ...
  private static final Array<ChitOuterClass.Chit> P3_INDIGENOUS_CHITS =
  ...
  private static final Map<String, Array<ChitOuterClass.Chit>> P3_CHITS =
      HashMap.of(
          "indigenous", P3_INDIGENOUS_CHITS,
  ...
  private static final SpecificationImpl.Builder P3_SPECIFICATION_BUILDER =
      SpecificationImpl.newBuilder(
              ...
              P3_CHITS,
              HashMap.ofEntries(
                  TileMappingUtils.newSelfReferringEntry("indigenous"),
  ...
  private static final Tuple2<Array<Tile>, Boolean> P4_INDIGENOUS_TILES =
      Tuple.of(
          Array.fill(2, TileUtils.newTile(FIELD))
              .appendAll(Array.fill(2, TileUtils.newTile(MOUNTAIN)))
  ...
  private static final Tuple2<Array<Tile>, Boolean> P4_FOREIGN_LAND_TILES =
      Tuple.of(
          Array.of(TileUtils.newTile(HILL), TileUtils.newTile(PASTURE))
              .appendAll(Array.fill(2, TileUtils.newTile(GOLD_FIELD)))
  ...
  private static final Array<Coordinate> P4_INDIGENOUS_COORDINATES =
      Array.of(
          CoordinateUtils.newCoordinate(3, 3),
          CoordinateUtils.newCoordinate(5, 3),
          CoordinateUtils.newCoordinate(7, 3),
  ...
  private static final Array<ChitOuterClass.Chit> P4_INDIGENOUS_CHITS =
      Array.of(CHITS_12)
  ...
  private static final Map<String, Array<ChitOuterClass.Chit>> P4_CHITS =
      HashMap.of(
          "indigenous", P4_INDIGENOUS_CHITS,
  ...
  private static final Tuple2<Array<Tile>, Boolean> P5_P6_INDIGENOUS_TILES =
      Tuple.of(
  ...
  private static final Array<Coordinate> P5_P6_INDIGENOUS_COORDINATES =
      Array.of(
  ...
  private static final Array<ChitOuterClass.Chit> P5_P6_INDIGENOUS_CHITS =
      Array.of(CHITS_2)
          .appendAll(Array.fill(2, CHITS_3))
          .appendAll(Array.fill(2, CHITS_4))
          .appendAll(Array.fill(2, CHITS_5))
  ...
  private static final Map<String, Array<ChitOuterClass.Chit>> P5_P6_CHITS =
      HashMap.of(
          "indigenous", P5_P6_INDIGENOUS_CHITS,
  ...
  private static final Tuple2<Array<Tile>, Boolean> P7_P8_INDIGENOUS_TILES =
      Tuple.of(
  ...
  private static final Array<Coordinate> P7_P8_INDIGENOUS_COORDINATES =
      Array.of(
          CoordinateUtils.newCoordinate(3, 1),
          CoordinateUtils.newCoordinate(2, 2),
          CoordinateUtils.newCoordinate(4, 2),
  ...
  private static final Array<Coordinate> P7_P8_FISHERY_COORDINATES = P5_P6_FISHERY_COORDINATES;
  private static final Map<String, Array<Coordinate>> P7_P8_COORDINATES =
      HashMap.of(
          "indigenous",
          P7_P8_INDIGENOUS_COORDINATES,
          "desert",
  ...
  private static final Array<ChitOuterClass.Chit> P7_P8_INDIGENOUS_CHITS =
  ...
  private static final Map<String, Array<ChitOuterClass.Chit>> P7_P8_CHITS =
      HashMap.of(
          "indigenous", P7_P8_INDIGENOUS_CHITS,
