...
public class TheCaravans {
  ...
  private static final Array<Tile> P3_P4_NON_PRODUCING_LAND_TILES = Array.of(OASIS);
  ...
  private static final Array<Coordinate> P3_P4_PRODUCING_LAND_COORDINATES =
      Base.P3_P4_LAND_COORDINATES.filterNot(P3_P4_OASIS_COORDINATES::contains);
  ...
  private static final SpecificationImpl.Builder P3_P4_SPECIFICATION_BUILDER =
      SpecificationImpl.newBuilder(
          ...
          HashMap.ofEntries(TileMappingUtils.newSelfReferringEntry("producing-land")));
  ...
  private static final Array<Tile> P5_P6_NON_PRODUCING_LAND_TILES = Array.fill(2, OASIS);
  ...
  private static final Array<Coordinate> P5_P6_OASIS_COORDINATES =
      Array.of(Coordinates.of(5, 3), Coordinates.of(9, 5));
  private static final Array<Coordinate> P5_P6_PRODUCING_LAND_COORDINATES =
      Base.P5_P6_LAND_COORDINATES.filterNot(P5_P6_OASIS_COORDINATES::contains);
  ...
  private static final Array<Tile> P7_P8_PRODUCING_LAND_TILES =
  ...
  private static final Array<Tile> P7_P8_NON_PRODUCING_LAND_TILES = Array.fill(3, OASIS);
  ...
  private static final Array<Coordinate> P7_P8_OASIS_COORDINATES =
      Array.of(Coordinates.of(5, 3), Coordinates.of(11, 3), Coordinates.of(8, 6));
  private static final Array<Coordinate> P7_P8_PRODUCING_LAND_COORDINATES =
      Base.P7_P8_LAND_COORDINATES.filterNot(P7_P8_OASIS_COORDINATES::contains);
