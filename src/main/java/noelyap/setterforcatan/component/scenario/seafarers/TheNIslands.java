...
public class TheNIslands {
  public static final Tuple2<Array<TileOuterClass.Tile>, Boolean> P3_ISLAND_TILES =
      Tuple.of(
  ...
  private static final Array<CoordinateOuterClass.Coordinate> P3_ISLAND_COORDINATES =
      Array.of(
  ...
  private static final Array<ChitOuterClass.Chit> P3_ISLAND_CHITS =
      Base.P3_P4_PRODUCING_CHITS.appendAll(Array.of(ChitUtils.CHITS_5, ChitUtils.CHITS_9));
  private static final Map<String, Array<ChitOuterClass.Chit>> P3_CHITS =
      HashMap.of("island", P3_ISLAND_CHITS);
  ...
  public static final Tuple2<Array<TileOuterClass.Tile>, Boolean> P4_ISLAND_TILES =
      Tuple.of(
          P3_ISLAND_TILES
              ._1
  ...
  private static final Array<CoordinateOuterClass.Coordinate> P4_ISLAND_COORDINATES =
      Array.of(
  ...
  private static final Array<ChitOuterClass.Chit> P4_ISLAND_CHITS =
      P3_ISLAND_CHITS.appendAll(
  ...
  private static final Map<String, Array<ChitOuterClass.Chit>> P4_CHITS =
      HashMap.of("island", P4_ISLAND_CHITS);
  ...
  public static final Tuple2<Array<TileOuterClass.Tile>, Boolean> P5_P6_ISLAND_TILES =
      Tuple.of(
  ...
  private static final Array<CoordinateOuterClass.Coordinate> P5_P6_ISLAND_COORDINATES =
      Array.of(
          CoordinateUtils.newCoordinate(3, 1),
          CoordinateUtils.newCoordinate(5, 1),
          CoordinateUtils.newCoordinate(9, 1),
  ...
  private static final Array<ChitOuterClass.Chit> P5_P6_ISLAND_CHITS =
  ...
  public static final Tuple2<Array<TileOuterClass.Tile>, Boolean> P7_P8_ISLAND_TILES =
      Tuple.of(
  ...
  private static final Array<CoordinateOuterClass.Coordinate> P7_P8_ISLAND_COORDINATES =
      Array.of(
          CoordinateUtils.newCoordinate(3, 1),
          CoordinateUtils.newCoordinate(5, 1),
          CoordinateUtils.newCoordinate(9, 1),
  ...
  private static final Array<ChitOuterClass.Chit> P7_P8_ISLAND_CHITS =
