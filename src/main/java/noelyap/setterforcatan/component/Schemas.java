...
public class Schemas {
  public static final Map<
          Scenario, HashMap<Range<Integer>, Tuple2<SpecificationImpl, SpecificationImpl>>>
      OFFICIAL_SCHEMAS =
          HashMap.of(
                  BASE,
                  HashMap.of(
                      Range.between(3, 4),
                      Tuple.of(
                          Base.P3_P4_SPECIFICATION_IMPL, Base.P3_P4_FISHERMEN_SPECIFICATION_IMPL),
                      Range.between(5, 6),
                      Tuple.of(
                          Base.P5_P6_SPECIFICATION_IMPL, Base.P5_P6_FISHERMEN_SPECIFICATION_IMPL),
                      Range.between(7, 8),
                      Tuple.of(
                          Base.P7_P8_SPECIFICATION_IMPL, Base.P7_P8_FISHERMEN_SPECIFICATION_IMPL)))
              .put(
              ...
              .put(
                  ...
                  HashMap.of(
                      Range.is(3),
                      Tuple.of(
                          Oceania.P3_SPECIFICATION_IMPL, Oceania.P3_FISHERMEN_SPECIFICATION_IMPL),
                      Range.is(4),
                      Tuple.of(
                          Oceania.P4_SPECIFICATION_IMPL, Oceania.P4_FISHERMEN_SPECIFICATION_IMPL),
                      Range.between(5, 6),
                      Tuple.of(
                          Oceania.P5_P6_SPECIFICATION_IMPL,
                          Oceania.P5_P6_FISHERMEN_SPECIFICATION_IMPL),
                      Range.between(7, 8),
                      Tuple.of(
              ...
              .put(
                  TRADERS_AND_BARBARIANS_BARBARIAN_ATTACK,
                  HashMap.of(
                      Range.between(3, 4),
                      Tuple.of(
                          BarbarianAttack.P3_P4_SPECIFICATION_IMPL,
                          BarbarianAttack.P3_P4_FISHERMEN_SPECIFICATION_IMPL),
                      Range.between(5, 6),
                      Tuple.of(
                          BarbarianAttack.P5_P6_SPECIFICATION_IMPL,
                          BarbarianAttack.P5_P6_FISHERMEN_SPECIFICATION_IMPL),
                      Range.between(7, 8),
                      Tuple.of(
